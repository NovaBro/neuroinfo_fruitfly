#!/bin/bash
# PatchPerPix long8h: RTX 6000 label+evaluate ALL val volumes @ ckpt 70000.
...
# Submit: sbatch sbatch/ppp/ppp_basic_long8h_full_val_rtx6000_sbatch.sh
#SBATCH --job-name=ppp_basic_long8h_full_val_rtx6000
...
#SBATCH --output=sbatch/ppp/ppp_basic_long8h_full_val_rtx6000.out
#SBATCH --error=sbatch/ppp/ppp_basic_long8h_full_val_rtx6000.err
...
nvidia-smi \
  ...
  --format=csv -l 3 \
  > gpu_usage_log_ppp_basic_long8h_full_val_rtx6000.csv &
GPU_LOGGER_PID=$!

# All 14 volumes under fisbe/completely/val; --checkpoint 70000 (not last/80000).
singularity exec --nv \
