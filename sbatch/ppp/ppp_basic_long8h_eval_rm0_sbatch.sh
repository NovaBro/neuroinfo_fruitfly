#!/bin/bash
# Re-eval ppp_basic_long8h ckpt 30000 with remove_small_components=0 (no retrain/predict).
# From repo root: sbatch sbatch/ppp/ppp_basic_long8h_eval_rm0_sbatch.sh
#SBATCH --job-name=ppp_basic_long8h_eval_rm0
#SBATCH --account=torch_pr_61_general
#SBATCH --cpus-per-task=4
#SBATCH --mem=32g
#SBATCH --time=00:30:00
#SBATCH --partition=cpu_short
#SBATCH --output=sbatch/ppp/ppp_basic_long8h_eval_rm0.out
#SBATCH --error=sbatch/ppp/ppp_basic_long8h_eval_rm0.err
